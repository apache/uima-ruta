...
public class RutaBuildpathContainerInitializer extends BuildpathContainerInitializer {
  ...
  public RutaBuildpathContainerInitializer() {
  }
  ...
  public void initialize(IPath containerPath, IScriptProject project) throws CoreException {
    ...
    IBuildpathContainer container = new UserLibraryBuildpathContainer("Descriptor Libraries", tk);
    DLTKCore.setBuildpathContainer(containerPath, new IScriptProject[] { project },
            new IBuildpathContainer[] { container }, new NullProgressMonitor());
  }

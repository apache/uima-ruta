...
public class SelectTypesDialog extends Dialog implements Listener {
  ...
  private AnnotationCheckComposite owner;
  ...
  public SelectTypesDialog(Shell shell, List<String> types, boolean excluded, AnnotationCheckComposite owner) {
    super(shell);
    this.shell = shell;
    this.types = types;
    this.owner = owner;
    this.selectedTypes = owner.getSelectedTypes();
    createDialogArea();
    init();
  }
    ...
    okButton.addSelectionListener(new SelectionAdapter() {
      ...
      public void widgetSelected(SelectionEvent event) {
        ...
        for (TableItem tableItem : items) {
          ...
          owner.setSelectedTypes(selection);
        shell.dispose();
      }
    });

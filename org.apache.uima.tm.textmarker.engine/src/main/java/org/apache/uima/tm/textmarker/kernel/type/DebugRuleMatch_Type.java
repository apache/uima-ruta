...
public class DebugRuleMatch_Type extends ProfiledAnnotation_Type {
   ...
   * @modifiable
   */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.uima.tm.textmarker.kernel.type.DebugRuleMatch");
  ...
  public int getElements(int addr) {
      ...
      jcas.throwFeatMissing("elements", "org.apache.uima.tm.textmarker.kernel.type.DebugRuleMatch");
  ...
  public boolean getMatched(int addr) {
      ...
      jcas.throwFeatMissing("matched", "org.apache.uima.tm.textmarker.kernel.type.DebugRuleMatch");
  ...
  public int getDelegates(int addr) {
      ...
      jcas.throwFeatMissing("delegates", "org.apache.uima.tm.textmarker.kernel.type.DebugRuleMatch");

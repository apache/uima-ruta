...
public class DebugBlockApply_Type extends DebugRuleApply_Type {
   ...
   * @modifiable
   */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.uima.tm.textmarker.kernel.type.DebugBlockApply");
  ...
  public int getInnerApply(int addr) {
      ...
      jcas.throwFeatMissing("innerApply", "org.apache.uima.tm.textmarker.kernel.type.DebugBlockApply");

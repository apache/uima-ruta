...
public class ProfiledAnnotation_Type extends Annotation_Type {
   ...
   * @modifiable
   */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.uima.tm.textmarker.kernel.type.ProfiledAnnotation");
  ...
  public long getTime(int addr) {
      ...
      jcas.throwFeatMissing("time", "org.apache.uima.tm.textmarker.kernel.type.ProfiledAnnotation");

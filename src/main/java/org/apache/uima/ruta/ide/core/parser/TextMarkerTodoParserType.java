...
public class TextMarkerTodoParserType extends AbstractTodoTaskBuildParticipantType {
  ...
  // return new TodoTaskPreferencesOnPreferenceLookupDelegate(TextMarkerIdePlugin.PLUGIN_ID,
  // project);
  // }

  @Override
  protected ITodoTaskPreferences getPreferences(IScriptProject project) {
    return new TodoTaskPreferences(TextMarkerIdePlugin.getDefault().getPluginPreferences());
  }
